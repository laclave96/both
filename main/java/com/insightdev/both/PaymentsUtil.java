...
public class PaymentsUtil {
    ...
    private static JSONObject getGatewayTokenizationSpecification() throws JSONException {
        return new JSONObject() {{
            ...
            put("parameters", new JSONObject() {{
                ...
                put("stripe:publishableKey", CheckoutActivity.PUBLIC_STRIPE_KEY);
            }});
        }};
    }
    ...
    private static JSONObject getTransactionInfo(String price) throws JSONException {
        ...
        transactionInfo.put("totalPriceLabel", price);
        transactionInfo.put("totalPriceStatus", "FINAL");
        transactionInfo.put("countryCode", Constants.COUNTRY_CODE);
        transactionInfo.put("currencyCode", Constants.CURRENCY_CODE);
        transactionInfo.put("checkoutOption", "COMPLETE_IMMEDIATE_PURCHASE");
        Log.d("aslkdjmañld", price);
    ...
    private static JSONObject getMerchantInfo() throws JSONException {
        return new JSONObject().put("merchantName", "Both Social");
    }
    ...
    public static JSONObject getPaymentDataRequest(double priceCents) {
        ...
        // Log.d("aslkdjmañld", price+" cent");

        try {
            JSONObject paymentDataRequest = PaymentsUtil.getBaseRequest();
            paymentDataRequest.put(
                    "allowedPaymentMethods", new JSONArray().put(PaymentsUtil.getCardPaymentMethod()));
            paymentDataRequest.put("transactionInfo", PaymentsUtil.getTransactionInfo(String.valueOf(priceCents)));
